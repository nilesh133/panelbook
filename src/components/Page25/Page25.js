...
import styles from "./page25.module.css"
const Page25 = () => {
  return (
    <div className={styles.page25}>
      <div className={styles.page25_section}>
        <div className={styles.page25_section_left}>
          <h3>Section</h3>
        </div>
        <div className={styles.page25_section_right}>
          <h3>01</h3>
          <h3>02</h3>
          <h3>03</h3>
          <h3>04</h3>
      ...
      <div className={styles.page25_heading}>
        <h1>02 {`>`} Asia Pacific</h1>
      </div>
      <div className={styles.page25_subheading}>
        <p>A global opportunity</p>
        <p>The highest standards</p>
        <p>Accountability at every step</p>
        <p>Working in partnerships</p>
      </div>
      <div className={styles.page25_content}>
        <div className={styles.page25_content_left}>
        ...
        <div className={styles.page25_content_right}>
          <h1>Mirats</h1>
          <h1>Insights</h1>
        </div>
      </div>
