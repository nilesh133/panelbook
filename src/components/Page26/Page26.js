...
import styles from "./page26.module.css"

// Images import
import image1 from "./images/page26_image1.png"
import image2 from "./images/page26_image2.png"
import image3 from "./images/page26_image3.png"
import image4 from "./images/page26_image4.png"
import image5 from "./images/page26_image5.png"

const Page26 = () => {
  return (
    <div className={styles.page26}>
        <div className={styles.page26_images}>
        ...
        <div className = {styles.page26_content}>
